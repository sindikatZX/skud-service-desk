...
export default async function CatalogPage() {
  ...
  const items = rows.map((i) => {
    ...
    return { id: i.id, sku: i.sku, name: i.name, externalCode: i.externalCode, categoryId: i.categoryId, unit: i.unit, isSerialized: i.isSerialized, manufacturer: i.manufacturer, isActive: i.isActive, ...a };
  });
